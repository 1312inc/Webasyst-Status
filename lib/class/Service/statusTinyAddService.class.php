    ...
    public function getAd(waContact $user): array
    {
        ...
        if (!wa()->appExists('tasks')) {
            $_tinyAds[] = [
                ...
                'buyurl' => $_webasyst_base_url . 'buy/store/1811/?buy_type=lease_year&utm_source=statusappwebasyst&utm_medium=inapp_tiny_ad&utm_campaign=1312_inapp_statusappwebasyst_tasksapp_wa' . $_whichUI,
        ...
        if (!wa()->appExists('cash')) {
            $_tinyAds[] = [
                ...
                'buyurl' => $_webasyst_base_url . 'buy/store/5136/?buy_type=lease_year&utm_source=statusappwebasyst&utm_medium=inapp_tiny_ad&utm_campaign=1312_inapp_statusappwebasyst_cashapp_wa' . $_whichUI,
